    ...
    <div className='border-stroke shadow-default dark:border-strokedark dark:bg-boxdark overflow-hidden rounded-sm border bg-white'>
      ...
      <div className='xl:pb-11.5 px-4 pb-6 text-center lg:pb-8'>
        ...
        <div className='mt-4'>
            ...
            {user.roles.map((role) => {
              return (
                <TextButton
                  ...
                  key={role.id}
                  className={cn(
                    'rounded-lg border px-3 disabled:!text-black',
                    activeRole.id == role.id
                      ? 'border-primary-600 font-bold'
          ...
          <div className='mt-4.5 mb-5.5 max-w-94 border-stroke shadow-1 dark:border-strokedark mx-auto grid grid-cols-3 rounded-md border py-2.5 dark:bg-[#37404F]'>
